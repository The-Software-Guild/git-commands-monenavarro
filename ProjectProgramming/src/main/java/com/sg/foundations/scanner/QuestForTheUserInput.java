...
public class QuestForTheUserInput {
    public static void main(String[] args) {
        ...
        // Using the Scanner's readLine to assign value to strings
        ...
        // For double data type, use Scanner's nextDouble method
        // or use the Double.parseDouble to convert the nextLine's String
